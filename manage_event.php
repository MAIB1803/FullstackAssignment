				...
				<form action="" id="manage-event">
					...
					<div class="form-group row">
						<div class="col-md-5">
							...
							<!-- schedule1 ->> is end date -->
							<input type="text" class="form-control datetimepicker" name="schedule1"  value="<?php echo isset($schedule1) ? date("Y-m-d H:i",strtotime($schedule1)) :'' ?>" required autocomplete="off">
						</div>
					</div>
					<div class="form-group row">
						<div class="col-md-5">
					...
					<div class="form-group row">
						<div class="col-md-5">
							...
							<input type="text" class="form-control" name="city_id"  value="<?php echo isset($city_id) ? $city_id :'' ?>" required>
						</div>
					</div>
					<div class="form-group row">
						<div class="col-md-10">
