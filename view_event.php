			...
			<div class="card-body">
				<div class="row">
					...
					<div class="col-md-12">
						...
						<p class="text-center"><small><b><i>Location: <?php echo ucwords($city_id) ?> , <?php echo ucwords($venue) ?></i></b></small></p>
					...
					<p class="">
						...
						<p><b>To </b></p>
						<p><b><i class="fa fa-calendar"></i> <?php echo date("F d, Y h:i A",strtotime($schedule1)) ?></b></p>
